...
(function () {
  ...
  /** @type {Array<{name:string, restaurant:string, price:number, originalPrice:number, qty:number}>} */
  ...
  /**
   * Adds an item to the cart. If the item already exists (by name & restaurant),
   * its quantity is incremented instead of adding a duplicate.
   * @param {{name:string, restaurant:string, price:number, originalPrice:number}} item
   */
  ...
  function wireAddToCartButtons() {
    document.querySelectorAll('.add-btn, .add-to-cart-btn').forEach(btn => {
      ...
      btn.addEventListener('click', function () {
        ...
        // Extract item data from the card's DOM elements
